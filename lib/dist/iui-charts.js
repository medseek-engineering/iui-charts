...
(function() {
  ...
  ChartController.$inject = ['$scope', 'iuiChartTimeLabels', 'iuiChartDefaultSettings'];
  function ChartController($scope, iuiChartTimeLabels, iuiChartDefaultSettings) {
    ...
    _.extend(settings, iuiChartDefaultSettings, $scope.chartSettings);
